...
function template_bi_board_lastpost($board)
{
	...
	echo '
			...
			<div class="node-extra-icon">', $board['last_post']['member']['avatar']['image'], '</div>
			<div class="topic-item-content">
				<div class="topic-item-title">', $board['last_post']['link'], '</div>
				<div class="topic-item-details">
					<div class="topic-item-poster">', $board['last_post']['member']['link'], '</div>
					<div class="topic-item-time"><i class="icon far fa-clock"></i> ', timeformat($board['last_post']['timestamp']), '</div>
				</div>
		</div>';
}
