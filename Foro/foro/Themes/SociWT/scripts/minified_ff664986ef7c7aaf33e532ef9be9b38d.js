...
smf_codeFix()};$(function(){$('#gobottom').click(function()
{$('html, body').animate({scrollTop:$(document).height()},1500);return!1});$('#gotop').click(function(){$('html, body').animate({scrollTop:'0px'},1500);return!1})});$(function(){$('ul.dropmenu, ul.quickbuttons').superfish({delay:250,speed:100,sensitivity:8,interval:50,timeout:1});$('.preview').SMFtooltip();$('a.bbc_link img.bbc_img').parent().css('border','0')});function smf_codeBoxFix()
...
{dir_elem.disabled=1}
else dir_elem.disabled=!sub_dir.checked};$(document).ready(function()
{$('#icon_count_input').change(function()
{var select_box=$('select#icon_image_input option:selected').val();var icon_count=$('#icon_count_input');if(icon_count.val()==0&&select_box!='blank.png')
icon_count.val(1);if(icon_count.val().length>2)
icon_count.val(99)});$('#icon_image_input').change(function()
{refreshIconPreview()});refreshIconPreview()});function refreshIconPreview()
{var icon_count=$('#icon_count_input');var select_box=$('select#icon_image_input').val();if(icon_count.val()==0&&select_box!='blank.png')
icon_count.val(1);$('#icon_preview').attr('src',smf_default_theme_url+'/images/membericons/'+select_box)};function smc_AutoSuggest(oOptions)
