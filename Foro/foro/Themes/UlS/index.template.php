...
<body id="', $context['browser_body_id'], '" class="action_', !empty($context['current_action']) ? $context['current_action'] : (!empty($context['current_board']) ?
	...
	echo '
        ...
        <img src="' . $settings['images_url'] . '/loader.svg" class="loader-img" alt="Loader">
    </div>
		<a href="#top_a" id="gotop" title="', $txt['go_up'], '">&#8593;</a>
		<a href="#bot_a" id="gobottom" title="', $txt['go_down'], '">&#8595;</a>';
		echo '
<div id="footerfix">
...
function template_body_above()
{
	...
	<div class="main-header">';
		 ...
		 echo '
			...
			if (!empty($settings['info_enabled']))
				 {
				echo '
			        <div class="content-wrapper-header">
						...
						echo '
						<h3 class="img-content">', $settings['info_title'] , '</h3>';
						if(!empty($settings['info_description']))
						echo '
                            <div class="content-text">', $settings['info_description'] , '</div>';

							if(!empty($settings['info_url']))
							echo '
                            <button class="content-button"><a href="', $settings['info_url'] , '">', $txt['read_more'], '</a></button>';
							echo '
                        </div>
                        <img class="content-wrapper-img" src="' . $settings['images_url'] . '/wt.png" alt="logo">
                    </div>';
				}
}
...
function heder_links()
{
	global $settings, $context, $scripturl;
		if (!empty($settings['enable_heder_links']))
		{
		echo'
			<div class="header-menu">';
			if (!empty($settings['link1']) && !empty($settings['name1']))
			echo '
			<a class="menu-link is-active" href="',$settings['link1'],'">',$settings['name1'],'</a>';
			if (!empty($settings['link2']) && !empty($settings['name2']))
			echo '
			<a class="menu-link notify" href="',$settings['link2'],'">',$settings['name2'],'</a>';
			if (!empty($settings['link3']) && !empty($settings['name3']))
			echo '
			<a class="menu-link notify" href="',$settings['link3'],'">',$settings['name3'],'</a>';
			echo '
			</div>';		
		}
}
