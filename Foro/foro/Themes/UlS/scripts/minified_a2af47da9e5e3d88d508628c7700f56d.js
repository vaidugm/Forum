...
{$('html, body').animate({scrollTop:$(document).height()},1500);return!1});$('#gotop').click(function(){$('html, body').animate({scrollTop:'0px'},1500);return!1})});$(window).on("load",function(e){$("#global-loader").fadeOut("slow")})
$(function(){$('ul.dropmenu, ul.quickbuttons').superfish({delay:250,speed:100,sensitivity:8,interval:50,timeout:1});$('.preview').SMFtooltip();$('a.bbc_link img.bbc_img').parent().css('border','0')});function smf_codeBoxFix()
...
function resetTheme(){if(darkSwitch.checked){document.body.setAttribute("data-theme","dark");localStorage.setItem("darkSwitch","dark")}else{document.body.removeAttribute("data-theme");localStorage.removeItem("darkSwitch")}}}});function smfCaptcha(imageURL,uniqueID,useLibrary,letterCount)
{if(!letterCount)
